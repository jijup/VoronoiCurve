...
//
// Licensees holding a afvalid commercial license may use this file in
...
namespace CGAL {
    ...
    public:
        ...
        //*************************************
        //  void del() const{
        //	  Delaunay_graph::Edge eit=this.dual().edges_begin();
        //do{
        //	if(eit->is_infinite())
        //		printf("Hello");
        //}while(eit!=this.dual().edges_end());
        //  }
        //
        //****************************************
    ...
    public:
        ...
        int initialize_status()
        {
            ...
            do{
                status[i].vits=vit;
                status[i].pi=vit->point();
                status[i].stat=true;
                status[i].visit=false;
                vit++;
                i++;
                count++;
